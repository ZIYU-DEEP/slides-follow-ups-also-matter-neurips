...
\begin{itemize}
    \item As in [Wang et al., 2016]~\footfullcite{wang2016learning}, a natural idea is to fit $\widehat{\phi}(\cdot)$, and obtain the parameter estimate by solving:
    {\small
    \begin{align}
    ...
    \begin{itemize}
        \item This requires improvement over the original Elliptical Potential Lemma (EPL) to accommodate noise in contexts during learning.
    \end{itemize}
\end{itemize}
